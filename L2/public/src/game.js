...
function create() {
    ...
    ledge = platforms.create(-75, 380, 'ground')
    ledge.body.immovable = true
    ...
    enemy = game.add.sprite(250, game.world.height - 290, 'enemy')
...
function update() {
    ...
    game.physics.arcade.collide(player, diamonds, collectDiamond, null, this)
...
function collectDiamond(player, diamond) {
    ...
    score += 10
    scoreText.text = 'Score: ' + score + "               Dont kill the human"
}